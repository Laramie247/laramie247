    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-900 font-sans pb-20">
            ...
            <main className="max-w-3xl mx-auto px-4 md:px-8 mt-8">
                ...
                >
                    {/* Meta Badge */}
                    <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-blue-50 text-blue-700 text-xs font-bold uppercase tracking-wider mb-6 shadow-sm ring-1 ring-blue-100">
                        {event.frequency}
                    </div>
                    ...
                    {/* Divider */}
                    <div className="w-24 h-1 bg-gray-200 rounded-full mx-auto mb-12" />
